...
PS1='${debian_chroot:+($debian_chroot)}\[\033[01;34m\]\u\[\033[1;30m\]@\[\033[0;31;47m\]\h\[\033[00m\] \$ '
...
#alias l='ls -CF'
alias o='less -SR'
alias pytest24='python2.4 `which py.test`'
alias less='less -R'
function svndiff() { svn diff $@ | colordiff; }

# Git funcs and aliases
alias grb='git svn rebase'
alias gadd='git add'
alias gb='git branch'
...
function gdiff () { git diff --no-prefix $@ | colordiff; }

# Mercurial funcs and aliases
alias hgl='thg log'
alias hgp='hg push'
